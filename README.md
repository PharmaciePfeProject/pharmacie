...
## 1.1 Intégration Power BI

Les rapports Power BI s'affichent **directement** dans l'application (sans lien externe) :

- 📊 Rapports affichés sur la page d'accueil (`/app/home`)
- 📈 Rapports complets en plein écran (`/app/bi`)
- ⚙️ Configuration simple via variables d'environnement
- 🔒 Support des URLs publiques et Power BI Embedded

**Démarrage rapide :** Voir [POWERBI_QUICK_START.md](POWERBI_QUICK_START.md)
