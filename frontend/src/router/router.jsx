    ...
    children: [
      {
        ...
        children: [
          ...
          {
            element: <PermissionRoute roles={[ROLES.RESPONSABLE_REPORTING]} />,
            children: [
          ...
          {
            element: <PermissionRoute permissions={[PERMISSIONS.APPOINTMENTS_MANAGE]} roles={[ROLES.SECRETAIRE_GENERAL]} functions={["SECRETAIRE_GENERAL"]} match="any" />,
            children: [
