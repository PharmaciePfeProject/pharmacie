...
export function EmptyState({ title, description, className, }) {
    const { t } = useLanguage();
    return (<div className={cn("flex flex-col items-center justify-center rounded-xl border border-dashed border-border bg-white px-6 py-12 text-center shadow-sm", className)}>
