...
import { PERMISSIONS, hasPermission, hasRole, type PermissionKey, type RoleKey } from "@/lib/roles";
...
const navSections: { titleKey: string; items: NavItem[] }[] = [
  {
    ...
    items: [{ labelKey: "nav.dashboard", to: "/app/dashboard", icon: LayoutDashboard }],
  },
  {
    ...
    items: [
      ...
      { labelKey: "nav.stockLots", to: "/app/stock-lots", icon: Archive, permissions: [PERMISSIONS.STOCKLOTS_READ] },
  ...
  },
  {
    ...
    items: [{ labelKey: "nav.inventories", to: "/app/inventories", icon: ClipboardCheck, permissions: [PERMISSIONS.INVENTORIES_READ] }],
  },
  {
    titleKey: "nav.analytics",
    items: [{ labelKey: "nav.biAnalytics", to: "/app/bi", icon: ChartColumnBig, permissions: [PERMISSIONS.ANALYTICS_READ] }],
  },
  {
    ...
    items: [
      ...
      { labelKey: "nav.doctorsManagement", to: "/app/admin/doctors", icon: Stethoscope, permissions: [PERMISSIONS.DOCTORS_MANAGE, PERMISSIONS.ADMIN_ACCESS] },
...
const pageMeta: Record<string, { titleKey: string; subtitleKey?: string }> = {
  ...
  "/app/admin/doctors": {
    titleKey: "page.adminDoctors.title",
    subtitleKey: "page.adminDoctors.subtitle",
  },
  "/app/admin/medicines": {
  ...
  "/app/stock-lots": {
    titleKey: "page.stockLots.title",
    subtitleKey: "page.stockLots.subtitle",
  },
  "/app/stock-movements": {
...
export default function AppShell() {
  ...
  const pageSubtitle = currentPage?.subtitleKey ? t(currentPage.subtitleKey) : t("nav.workspaceSubtitle");
              ...
              {!collapsed && (
                <div className="min-w-0">
                  <p className="truncate font-semibold">
                    ...
                    <p className="truncate text-sm text-muted-foreground">{user?.function || t("nav.workspaceUser")}</p>
                </div>
              )}
            </div>
          </div>
