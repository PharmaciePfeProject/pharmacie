  ...
  return (
    <div className="space-y-6">
      ...
      {product && !loading && !error && (
        <>
          <DetailHero
            eyebrow={t("products.table.title")}
            title={product.lib || t("products.details.unnamed")}
            description={t("products.details.description")}
            badge={`${t("common.product")} #${product.product_id}`}
          />
          ...
          <DetailStatGrid>
            ...
            <DetailStatCard
              label={t("products.details.vatRate")}
              value={typeof product.vat_rate === "number" ? `${product.vat_rate}%` : t("common.notAvailable")}
            />
          </DetailStatGrid>

          <div className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <DetailSection
              title={t("products.details.thresholdsTitle")}
              description={t("products.details.thresholdsDescription")}
            >
            ...
            <DetailSection
              title={t("products.details.referenceTitle")}
              description={t("products.details.referenceDescription")}
            >
              <div className="grid gap-4 p-6 md:grid-cols-2">
                <div className="rounded-2xl border bg-muted/20 p-4">
