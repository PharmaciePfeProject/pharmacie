    ...
    return (<div className="space-y-6">
      <Card className="border-white/70 bg-white/95 shadow-sm">
        ...
        <CardContent className="flex flex-wrap gap-3">
          ...
          <Button asChild className="rounded-2xl">
            <Link to="/app/bi/stock">{t("bi.report.stock")}</Link>
          </Button>
          <Button asChild className="rounded-2xl">
            <Link to="/app/bi/prescriptions">{t("bi.report.consumption")}</Link>
          </Button>
          <Button asChild className="rounded-2xl">
            <Link to="/app/bi/distributions">{t("bi.report.distribution")}</Link>
          </Button>
          <Button asChild className="rounded-2xl">
            <Link to="/app/bi/reporting">{t("bi.report.movements")}</Link>
          </Button>
