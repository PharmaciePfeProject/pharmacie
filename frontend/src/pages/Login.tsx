        ...
        <div className="hidden flex-col justify-between rounded-[32px] border border-white/70 bg-white/80 p-10 shadow-[0_30px_80px_rgba(15,23,42,0.08)] backdrop-blur lg:flex">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <h1 className="mt-2 text-3xl font-semibold text-foreground">{t("auth.brandTitle")}</h1>
            </div>
          </div>
          ...
          <CardHeader className="space-y-4 pb-6">
            <div className="flex items-center gap-3 lg:hidden">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">{t("nav.pharmacyPlatform")}</p>
              </div>
            </div>
            <CardTitle className="text-3xl">{t("auth.loginTitle")}</CardTitle>
            <p className="text-sm leading-6 text-muted-foreground">{t("auth.loginSubtitle")}</p>
          </CardHeader>
          <CardContent>
