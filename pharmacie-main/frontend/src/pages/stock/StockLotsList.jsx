        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-6">
          ...
          <div className="col-span-2 space-y-2 md:col-span-1">
            ...
            <Input
              ...
              placeholder={t("stockLots.lotPlaceholder")}
            />
          </div>
        </div>
              ...
              <tbody>
                {items.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      {item.lot_id ?? t("common.notAvailable")}
                    </td>
                    <td className="px-4 py-3">
                      {item.lot_label || t("common.notAvailable")}
                    </td>
                    <td className="px-4 py-3">
                      {item.lot_state ?? t("common.notAvailable")}
                    </td>
                    <td className="px-4 py-3">
                      {item.date_refusal
                        ? new Date(item.date_refusal).toLocaleDateString()
